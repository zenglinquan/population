	...
	<div class="main">
		<ul class="container">
			<ul class="login">
				...
				<li class="topC"><span class="title"> 
				</span></li>
				<li class="login-main">
					<ul class="loginA">
						<span><img src="<%=basePath%>image/pop-5.png" alt="" /></span>
					</ul>
					<form id="loginForm" class="loginB" action="admin/login" method="post">
						<ul class="loginB-top">
						...
						<li class="login-btn">
							...
							<button class="btn" type="submit" id="reset" style="margin-left:30px">重置</button>
						</li>
					</form>
				</li>
			</ul>
