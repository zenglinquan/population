...
//  this.buttons.push(new Button(context, getLangString("start").toUpperCase(), 21, 285 + offsetY, 178, 89, [this.emptyButton], BUTTON_LAYOUT_NORMAL_BUTTON, function(){game.showShopScreen(RETURNSCREEN_STARTSCREEN);}, 0.44));
    this.buttons.push(new Button(context, getLangString("start").toUpperCase(), 21, 378 + offsetY, 178, 89, [this.emptyButton], BUTTON_LAYOUT_NORMAL_BUTTON, function(){
    	game.startLevel(4);
    	$('.breatheDiv').css({'opacity':'1'});
    }, 0.44));
//  if (mg) {
...
//  }
    ...
    this.centerTitle = {image:loadImage("images/titlescreen/title2.png"), x:300, y:-173};
    ...
    this.egg1 = {image:loadImage("images/titlescreen/yuan.png"), x:800, y:359};
    this.egg2 = {image:loadImage("images/titlescreen/coin.png"), x:912, y:359}; 
};
